...
2. When you evaluate the odds of something happening, you have to make sure that it is the inverse of the odds of something NOT happening.  Sometimes looking at a problem forwards and backwards will help you see a blind spot.<br>
...
GetMonty = function(Doors, N) {
  ...
  for (i in 1:N) {
    ...
    TempDF = TempDF %>%
      ...
      NotRevealed = sample(Doors[-c(Car, Guess)], 1),
