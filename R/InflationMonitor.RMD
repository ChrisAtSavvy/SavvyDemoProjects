...
#PriorYear = max(PresentationDF$QuoteDate) - months(12)
PriorYear = CurrentMonth - months(12)
#PriorYear2 = max(PresentationDF$QuoteDate) - months(24)
PriorYear2 = CurrentMonth - months(24)
#PriorYear3 = max(PresentationDF$QuoteDate) - months(36)
...
Plot1 = PresentationDF %>%
  ...
  ggplot(aes(QuoteDate, MetricValue)) +
   geom_line(size = 2, color = LineColor, na.rm = TRUE) +
   theme_classic() +
